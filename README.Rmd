...
To install this package from MSUGitLab, first clone the entire repository to local machine using git clone command
then install from the local copy by specifying where the local copy reside
